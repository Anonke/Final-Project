...
import 'package:flutter_auth/utils/dash/BHConstants.dart';
import 'package:flutter_auth/utils/dash/T14Colors.dart';
import 'package:flutter_auth/utils/dash/T14Images.dart';
...
List<SubscriptionModel> getTopTravelList() {
  ...
  topTravelList.add(SubscriptionModel(name: 'What Is Mental Health?', img: t14_travel1, url: 'https://www.youtube.com/watch?v=oxx564hMBUI'));
  topTravelList.add(SubscriptionModel(name: 'Achieve optimum mental health', img: t14_travel2, url: 'https://www.youtube.com/watch?v=oWjSdwzOA6k'));
